# ⚡ ESP32 Thermogravimetric Thermal Analysis (TGA) Furnace Controller
...
Materials science instrument synchronizing micro-weight loss measurement with high-temperature furnace thermal curves up to 1000°C via dual SPI thermocouples.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-tga-furnace-controller.ino`](./esp32-tga-furnace-controller.ino).
