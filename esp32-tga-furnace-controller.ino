/**
 * =========================================================================================
 * Project     : ESP32 Thermogravimetric Thermal Analysis (TGA) Furnace Controller
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Materials science instrument synchronizing micro-weight loss measurement with high-temperature furnace thermal curves up to 1000°C via dual SPI thermocouples.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-tga-furnace-controller";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Thermogravimetric Thermal Analysis (TGA) Furnace Controller"));
